...
public class Get10 extends GoRestBaseUrl {
    ...
    "data": {
        "id": 2986,
        "name": "Rohana Varman",
        "email": "varman_rohana@haag-glover.co",
        "gender": "male",
        "status": "active"
              }
}
    ...
    public void get01(){
        ...
        Map<String , String> dataKeyMap = dataKey.dataKeyMap("Rohana Varman", "varman_rohana@haag-glover.co","male","active");//İç Map'i oluşturuyorum.
